...
int main()
{
	...
	result = generator(message, polynomial);  /* get the remainder of CRC */
	...
	cin >> index;
	result = alter(index, message+generator(message, polynomial));  /* get the altered version of transmitted message */
	error << result;
	error << "\n"<<polynomial;
	verify(result, polynomial);
	cout << endl << "transmitted message ---> " << result << "\n";
